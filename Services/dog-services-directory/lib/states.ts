// US States with their two-character abbreviations
...
// Function to get states sorted alphabetically
export function getSortedStates(): USState[] {
  return [...US_STATES].sort((a, b) => a.name.localeCompare(b.name));
}

// Function to get a state by its abbreviation
...
// Function to get a state by its name
