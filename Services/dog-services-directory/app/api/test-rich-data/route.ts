...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('Testing rich data extraction for:', websiteUrl);
    ...
    return NextResponse.json({ 
      message: 'Rich data extraction test successful',
      websiteUrl,
    ...
    console.error('Rich data extraction test error:', error);
    return NextResponse.json(
