...
export default function TouchpointEditModal({ 
  ...
  const [formData, setFormData] = useState<Touchpoint | null>(null)

  // Initialize form data when touchpoint changes
  useEffect(() => {
    if (touchpoint) {
  ...
  if (!isOpen || !touchpoint || !formData) return null

  const handleInputChange = (field: keyof Touchpoint, value: any) => {
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        ...
                        handleInputChange('typeIcon', getTypeIcon(newType))
                        handleInputChange('typeColor', getTypeColor(newType))
                      }}
