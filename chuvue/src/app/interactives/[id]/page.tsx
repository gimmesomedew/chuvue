            ...
            >
              <div className="p-6">
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-2xl font-bold text-white">{previewChapter.title}</h2>
                  <button
                ...
                <div className="space-y-4">
                  <p className="text-gray-300">{previewChapter.description}</p>
                  
                  <div className="flex items-center space-x-4 text-sm text-gray-400">
                    <span>{previewChapter.views} views</span>
                    <span>•</span>
                    <span className={`px-2 py-1 rounded-full text-xs ${getStatusColor(previewChapter.status)}`}>
                      {previewChapter.status}
                    </span>
                  </div>
                </div>
              </div>
